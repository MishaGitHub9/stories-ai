-- Скрипт для оновлення існуючої схеми бази даних
-- Виконайте цей скрипт, якщо у вас вже є база даних зі старою схемою

-- 1. Видаляємо старі тригери та функції
...
-- 3. Оновлюємо таблицю profiles (додаємо нові поля)
ALTER TABLE profiles 
ADD COLUMN IF NOT EXISTS trial_start_date TIMESTAMP WITH TIME ZONE,
ADD COLUMN IF NOT EXISTS trial_end_date TIMESTAMP WITH TIME ZONE;

-- 4. Створюємо нові таблиці
...
-- 7. Політики безпеки для stories
...
-- 8. Політики безпеки для story_messages
...
-- 9. Політики безпеки для subscriptions
...
-- 10. Створюємо нову функцію для автоматичного створення профілю
...
-- 11. Створюємо новий тригер
CREATE TRIGGER on_auth_user_created
  AFTER INSERT ON auth.users
  FOR EACH ROW EXECUTE FUNCTION public.handle_new_user();

-- 12. Створюємо тригери для автоматичного оновлення updated_at
...
-- 13. Створюємо функцію для скидання денних лімітів
